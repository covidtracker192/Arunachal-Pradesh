        ...
        goafund.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(home.this)
                        ...
                        .setMessage("You will be redirected to the official payment link of Arunachal Pradesh state COVID-19 Relief Fund. Do you want to continue?")
                        .setPositiveButton("Continue", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                // Continue with COVID-19 goa relief fund
                                Uri uriUrl = Uri.parse("http://www.arunachalpradesh.gov.in/donation-to-chief-ministers-relief-fund/");
                                Intent launchBrowser = new Intent(Intent.ACTION_VIEW, uriUrl);
                                startActivity(launchBrowser);
                            }
                        })
